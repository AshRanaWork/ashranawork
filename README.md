...
📊 **Featured projects:**
- **[AI Data Analyst Agent](https://github.com/AshRanaWork/ai-data-analyst-agent)** — An autonomous agent that answers plain-English business questions by writing and running its own SQL against a database, with a live web app and full decision logs. Built with Python + Gemini API.
